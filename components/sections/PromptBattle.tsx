...
function ScoreBar({ score, side }: { score: number; side: "novice" | "expert" }) {
  ...
  return (
    <div className="mt-3">
      <div className="flex justify-between text-sm mb-1">
        <span className="text-slate-400">AI 응답 품질</span>
        <span className={isLow ? "text-red-400 font-bold" : "text-emerald-400 font-bold"}>
          {score}/100
        </span>
      </div>
    ...
    >
      ...
      <div className="grid md:grid-cols-[1fr_auto_1fr] grid-cols-1">
        ...
        <div className="p-5 space-y-3">
          ...
          <ScoreBar score={battle.novice.score} side="novice" />
        </div>
        ...
        <div className="p-5 space-y-3">
          ...
          <ScoreBar score={battle.expert.score} side="expert" />
        </div>
      </div>
